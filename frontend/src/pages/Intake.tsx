...
const interestOptions: Option[] = [
    ...
    { value: "computational theory", label: "computational theory" },
    ...
    { value: "flight dynamics", label: "flight dynamics" },
    ...
    { value: "hybrid systems", label: "hybrid systems" },
    ...
    { value: "internal combustion engines", label: "internal combustion engines" },
    { value: "internet of things", label: "internet of things" },
    { value: "kinematics", label: "kinematics" },
    { value: "laser physics", label: "laser physics" },
    { value: "lean manufacturing", label: "lean manufacturing" },
    { value: "logistics", label: "logistics" },
    { value: "machine learning", label: "machine learning" },
    { value: "manufacturing", label: "manufacturing" },
    { value: "material properties", label: "material properties" },
    ...
    { value: "micro-fabrication", label: "micro-fabrication" },
    ...
    { value: "mine safety", label: "mine safety" },
    ...
    { value: "radiation protection", label: "radiation protection" },
    { value: "reaction engineering", label: "reaction engineering" },
    { value: "reaction kinetics", label: "reaction kinetics" },
    { value: "reactor safety", label: "reactor safety" },
    ...
    { value: "rock mechanics", label: "rock mechanics" },
    { value: "satellite technology", label: "satellite technology" },
